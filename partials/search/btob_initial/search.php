					...
					<table class="half">
						...
						<tr>
							<td>
								...
								<h5>Autre pays</h5>
								<input type="hidden" id="autre_pays" name="autre_pays" class="multiinput" style="width: 90%; height: 50%;" />
							</td>
							<td>
								...
								<h5>Code postal</h5>
								<input type="hidden" id="cp" name="cp" class="multiinput" style="width: 90%; height: 150%" />
							</td>
						</tr>
					</table>
				</div>
