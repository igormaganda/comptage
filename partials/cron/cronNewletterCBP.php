...
try {
    ...
    foreach ($categories_result as $category) {
        ...
        // Générer le template complet
            ...
            FROM 
                public.product_matchs
            WHERE 
                (status_product='my' OR status_product='mn') 
                AND category_product = ?
            GROUP BY 
                category_product,
                brand_product,
    ...
    foreach ($categories_result as $category) {
        ...
        $products_query = "SELECT 
                    MIN(title_product) AS title_product,
                    price_product,
                    MIN(image_product) AS image_product,
                    MIN(link_product) AS link_product,
                    category_product,
                    brand_product
                FROM 
                    public.product_matchs
                WHERE 
                    (status_product='mx' OR status_product='mn') 
                    AND category_product = ?
                GROUP BY 
                    category_product,
                    brand_product,
        ...
        // Générer le template complet
            ...
            $products_query = "SELECT 
                ...
                FROM 
                    public.product_matchs
                WHERE 
                    (status_product='mx' OR status_product='my') 
                    AND category_product = ?
                GROUP BY 
                    category_product,
                    brand_product,
