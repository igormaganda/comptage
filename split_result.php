...
<head>
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Split')); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center gy-3">
                            <div class="col-md">
                                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Split', 'title' => 'Résultat')); ?>
                            </div><!--end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        <p class="fs-md mb-0 flex-grow-1">Totals</p>
                        ...
                        <div class="col-lg-12">
                            <div class="card" id="customerList">
                                <div class="card-header d-flex align-items-center">
                                    <h5 class="card-title flex-grow-1 mb-0">Résultat des split</h5>
                                    <div class="flex-shrink-0">
                                        <button class="btn btn-subtle-danger d-none" id="remove-actions" onClick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button>
                                        <button class="btn btn-primary add-btn" onclick="redirigerVersLien()"><i class="bi bi-plus align-baseline"></i>Nouveau split</button>
                                    </div>
                                </div>
                                <div class="card-body pt-2">
                                    <divt class="table-responsive table-card">
                                        <table class="table table-custom align-middle table-borderless table-custom-effect table-nowrap mb-0">
                                            <thead class="table-light">
                                                <tr>
                                                    <th class="sort cursor-pointer" data-sort="fichier">Fichier</th>
                                                    <th class="sort cursor-pointer" data-sort="troncon">Tronçon</th>
                                                    <th class="sort cursor-pointer" data-sort="xchiffre">Exclusion de plus de X chiffre(s)</th>
                                                    <th class="sort cursor-pointer" data-sort="xcaract">Exclusion deplus de X caractère(s)</th>
                                                    <th class="sort cursor-pointer" data-sort="caract_speciaux">Mails avec les suites de caractères</th>
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr id="parentDiv">
                                                    <td class="">MisterDestockeur</td>
                                                    <td class="">65</td>
                                                    <td class="">4</td>
                                                    <td class="">16</td>
                                                    <td class="">adol mixt deskto</td>
                                                    <td class="date"></td>
                                                    <td>
                                                        <div class="flex-shrink-0">
