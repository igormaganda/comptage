...
<head>
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Partenaires(asso-aide)')); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Gestion', 'title' => 'Partenaires(asso-aide)')); ?>
                            </div><!--end col-->
                                ...
                                <div class="card-body">
                                    <div class="widget">
                                        <div class="widget-body innerAll inner-2x">
                                            ...
                                            $requete = "SELECT id, Nom, Key FROM gestion_partenaire_assoaide ORDER BY id";
                                            ...
                                            echo '<table id="scroll-horizontal" class="dynamicTable colVis table table-bordered table-striped table-hover align-middle" style="width:100%">
                                                <thead class="bg-gray">
                                                    <tr>
                                                        ...
                                                        <th style="text-align:start; width: auto;">clée</th>
                                            ...
                                            while ($partenaire = $result->fetch()) {
                                                ...
                                                echo '<td style="text-align:start; width: auto;">' . $partenaire->key . '</td>';
                                                echo '<td style="text-align:center; width: 135px;" class="action_count" style="text-align:center;">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm btn-sup" onclick="rmPartenaireAssoaide(' . $partenaire->id . ')"><i class="bx bxs-trash"></i></button>
                                                </td>';
                                                echo '</tr>';
                                            }
                                            echo '</tbody></table>';
                    ...
                    <div class="modal fade" id="modal_new_prog" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="assoaide_a.php" name="form_categorie" id="form_categorie">
