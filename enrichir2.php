                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-lg-5 d-flex justify-content-center">
                            <div class="card mb-lg-5 w-75">
                                <div class="card-body">
                                    <div class="widget">
                                        <div class="widget-body d-flex justify-content-center  m-3">
                                            <form method="POST" action="enrichir3.php" id="form_validation" class="row g-3">
                                                ...
                                                <?php if (isset($_POST["insert"])) { ?>
                                                    <div class="justify-content-center text-center">
                                                        ...
                                                        <?php if ($_POST["b2b-b2c"] == "b2c") { ?>
                                                            ...
                                                            <div class="row d-flex justify-content-center text-center" id="filetype">
                                                                ...
                                                                <select name="programme" class="form-select input-lg mb-3 w-100" id="programme">
                                                        ...
                                                        <div class="justify-content-center text-center">
                                                            <?php if ($_POST["b2b-b2c"] == "b2b") { ?>
                                                                <div class=" row d-flex justify-content-center text-center" id="filetype">
                                                                    ...
                                                                    <select name="pays" class="form-select input-lg mb-1 w-100" id="pays">
                                                    ...
                                                    <div id="input_search_submit" class="mt-lg-2 text-center">
