...
var Invoices = [
    {
        invoice_no: '24301901',
        logo_img: 'https://img.themesbrand.com/judia/logo-dark.png',
        customer: 'Themesbrand',
        email: "themesbrand@judia.com",
        ...
        sign_img: 'https://img.themesbrand.com/judia/invoice-signature.svg',
    }, {
        invoice_no: '24301902',
        logo_img: 'https://img.themesbrand.com/judia/logo-dark.png',
...
if (checkAll) {
    checkAll.onclick = function () {
        var checkboxes = document.querySelectorAll('.form-check-all input[type="checkbox"][name="chk_child"]');
...
var invoiceList = new List("invoiceList", options).on("updated", function (list) {
    ...
    const totalRecordsElement = invoiceList.listContainer.querySelector(".total-records");
    const showingElement = invoiceList.listContainer.querySelector(".showing");

    if (totalRecordsElement) totalRecordsElement.innerHTML = invoiceList.items.length;
    if (showingElement) showingElement.innerHTML = invoiceList.visibleItems.length;
});
