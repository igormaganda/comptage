...
var todoList = [{
    ...
    "assignedto": [{
        ...
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-1.jpg",
    }, {
        "assigneeName": "John Robles",
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-3.jpg",
    }
    ],
    'dueDate': '03 Apr, 2022',
    'status': 'Inprogress',
    ...
    "assignedto": [{
        ...
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-5.jpg",
    }, {
        "assigneeName": "Diego Norris",
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-9.jpg",
    }, {
        "assigneeName": "Anthony Mills",
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-10.jpg",
    }
    ],
    'dueDate': '02 Apr, 2022',
    'status': 'Pending',
    ...
    "assignedto": [{
        ...
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-6.jpg",
    }, {
        "assigneeName": "Johnnie Walton",
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-7.jpg",
    }, {
        "assigneeName": "Donna Weston",
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-8.jpg",
    }
    ],
    'dueDate': '02 May, 2023',
    'status': 'Completed',
    ...
    "assignedto": [{
        ...
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-2.jpg",
    }
    ],
    'dueDate': '01 May, 2023',
    'status': 'New',
    ...
    "assignedto": [{
        ...
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-4.jpg",
    }, {
        "assigneeName": "Virgie Price",
        "assigneeImg": "https://img.themesbrand.com/judia/users/avatar-5.jpg",
    }
...
// add new project
// get rendom icons in projects
function getRandomItem(iconclasslist) {
...
Array.prototype.slice.call(createFolderForms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        if (!form.checkValidity()) {
            ...
            var icon = getRandomItem(iconclasslist);
            projectlisthtml =
                '<li id="projectlist-' + uniqueid + '">\
        <a data-bs-toggle="collapse" href="#projectCollapse-'+ uniqueid + '" class="nav-link"><i class="' + icon.iconclass + '"></i>' + projectName + '</a>\
        <div class="collapse" id="projectCollapse-'+ uniqueid + '">\
            ...
            if (projectName !== "") {
                ...
                projectListdata.insertAdjacentHTML("afterbegin", projectlisthtml);
...
var createFolderForms = document.querySelectorAll('.createInsights-form')
Array.prototype.slice.call(createFolderForms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        if (!form.checkValidity()) {
            event.preventDefault();
            ...
            event.preventDefault();
            var projectName = document.getElementById("insightsname-input").value;
            var uniqueid = Math.floor(Math.random() * 100);
        ...
        <div class="collapse" id="projectCollapse-'+ uniqueid + '">\
            ...
            if (projectName !== "") {
                var projectListdata = document.getElementById("Insightslist-data");
                console.log(projectListdata)
                projectListdata.insertAdjacentHTML("afterbegin", insightslisthtml);
                var addProjectClose = document.getElementById("addInsightstBtn-close");
                addProjectClose.click();
            }
        }
        form.classList.add('was-validated');
...
const insightsModalEl = document.getElementById('createInsightstModal')
insightsModalEl.addEventListener('show.bs.modal', event => {
    document.getElementById("insightsname-input").value = "";
    document.querySelectorAll(".createInsights-form").forEach(function (item) {
        item.classList.remove("was-validated");
    })
})
...
document.getElementById("creattask-form").addEventListener("submit", function (e) {
    ...
    if (inputTitle.length == 0 || assignedTo.length == 0 || statusInputFieldValue == "" || priorityInputFieldValue == "" || inputDate.length == 0) {
    ...
    Array.from(manyTodos).forEach(function (singleTodo) {
        ...
        document.getElementById("task-list").innerHTML +=
            ...
            <div class="hstack gap-2">\
                <button class="btn btn-sm btn-subtle-danger remove-list" data-bs-toggle="modal" data-bs-target="#removeTaskItemModal" data-remove-id='+ singleTodo.id + '><i class="ri-delete-bin-5-fill align-bottom"></i></button>\
                <button class="btn btn-sm btn-subtle-info edit-list" data-bs-toggle="modal" data-bs-target="#createTask" data-edit-id='+ singleTodo.id + '><i class="ri-pencil-fill align-bottom"></i></button>\
            </div>\
            </td>\
        </tr>';
...
var todoMenuSidebar = document.getElementsByClassName('todo-sidebar');
Array.from(document.querySelectorAll(".todo-menu-btn")).forEach(function (item) {
...
window.addEventListener('click', function (e) {
    if (document.querySelector(".todo-sidebar").classList.contains('menubar-show')) {
        if (!isShowMenu) {
            document.querySelector(".todo-sidebar").classList.remove("menubar-show");
        }
        isShowMenu = false;
    }
});
