                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        ...
                                                                        <input type="radio" class="btn-check" name="cocherhabitat" id="danger-outlined" checked>
                                                                        <label class="btn btn-outline-light" for="danger-outlined">Tout décocher</label>
                                                                    </div>
                                                                </div>
                                                        </div>
                                                ...
                                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#default-accordion-example">
                                                    <div class="accordion-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input type="number" class="form-control" min="1" id="">
                                                            </div>
                                                            <div class="col-md-2">
                                                    ...
                                                    <div class="accordion-body">
                                                         <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select required multiple="multiple" name="favorite_fruits" id="multiselect-inclusion">
                                                                    <option selected>Apple</option>
                                                                    <option>Banana</option>
                                                                    <option selected>Blueberry</option>
                                                                    <option selected>Cherry</option>
