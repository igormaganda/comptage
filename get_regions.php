...
if(isset($_POST['top_pays']) ) {
    ...
    $sql = "SELECT DISTINCT name_region FROM gestion_pays WHERE country_name = ?";
    ...
    try {
        ...
        foreach($selectedCountries as $country) {
            ...
            foreach($regions as $row) {
                $options .= "<option value='" . $row['name_region'] . "'>" . $row['name_region'] . "</option>";
            }
        }
    ...
    echo "<option value=''>Aucun pays sélectionné</option>";
}
?>
