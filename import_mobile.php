                ...
                <div class="container-fluid">
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Importation', 'title' => 'Import de data (Mobile)')); ?>
                            </div>
                            <!--end col-->
                    ...
                    <div class="row">
                        <div class="col-xxl-12 mb-lg-5 d-flex justify-content-center">
                            <div class="card mb-lg-5 w-75">
                                ...
                                <div class="card-body tab-content d-flex text-center justify-content-center m-3 ">
                                    <div class="tab-pane show active" id="formGuttersPreview" role="tabpanel" aria-labelledby="formGuttersPreview-tab" tabindex="0">

                                        <form method="post" action="import_mobile2.php" enctype="multipart/form-data" class="row g-3">
