                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mt-1 mt-lg-0">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <?php $requete = "SELECT country_name FROM gestion_pays GROUP BY country_name ORDER BY country_name DESC LIMIT 12";
                                                                                $results = $bdd->executeQueryRequete($requete, 1);
                                                                                while( $result = $results->fetch() ) { ?>
                                                                                    <div class="col-lg-6">
                                                                                        <div class="form-check form-switch form-switch-lg" dir="ltr">
                                                                                            <input type="checkbox" name="pays_top" value="<?=  $result->country_name ?>" class="form-check-input" id="customSwitchsizemd">
