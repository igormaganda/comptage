...
require_once("partials/class/Upload[mobile].php");
				...
				<div class="container-fluid">
					...
					<div class="page-title-box">
						<div class="row align-items-center">
							<div class="col-md-5">
								<?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Recherche', 'Importation' => 'Import de dta (Mobile)')); ?>
							</div><!--end col-->
								...
								<div class="card-body">
									<div class="widget">
										<div class="widget-body  d-flex justify-content-center  m-3">
											<form method="POST" action="import_mobile3.php" id="form_validation" class="row g-3">
